...
* link:example/general/README.adoc[Exploration of general circuit-breaker usage.] Built with Java, Resilience4J, and Spring Boot.

* link:example/operations-api/README.adoc[Implement an operations REST API to manipulate circuit-breakers at runtime.] Built with Java, Resilience4J, and Spring Boot.
